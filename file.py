kinetics_400_labels = [
    ...
    "carrying baby", "cartwheeling", "carving pumpkin", "catching fish", "celebrating",
    ...
    "hurdling", "hurling", "ice climbing", "ice fishing", "ice skating", "ironing",
    ...
    "making bed", "making jewelry", "making pizza", "making snowman", "making sushi",
    ...
    "parasailing", "parkour", "passing American football", "passing soccer ball", "peeling apples",
    "peeling potatoes", "petting animal", "picking fruit", "planting trees", "plastering",
    "playing accordion", "playing badminton", "playing bagpipes", "playing basketball",
    "playing bass guitar", "playing cards", "playing cello", "playing chess", "playing clarinet",
    "playing controller", "playing cricket", "playing cymbals", "playing didgeridoo",
    ...
    "playing organ", "playing paintball", "playing piano", "playing poker", "playing recorder",
    "playing saxophone", "playing squash", "playing trombone", "playing trumpet",
    ...
    "punching bag", "punching person", "push up", "pushing car", "pushing cart", "pushing wheelchair",
    ...
    "riding scooter", "rock climbing", "rock scissors paper", "roller skating", "running on treadmill",
    "sailing", "salsa dancing", "shaking hands", "shaking head", "sharpening knives",
    "shaving head", "shearing sheep", "shooting basketball", "shooting goal", "shot put",
    "shoveling snow", "shredding paper", "shuffling cards", "side kick", "sign language interpreting",
    "singing", "situp", "skateboarding", "ski jumping", "skiing crosscountry",
    "skiing slalom", "skipping rope", "skydiving", "slacklining", "slapping", "sled dog racing",
    "smoking", "snatch weight lifting", "sneezing", "sniffing", "snorkeling", "snowboarding",
    "snowkiting", "snowmobiling", "somersaulting", "sowing seeds", "spinning poi", "splitting wood",
    "spooning", "spray painting", "spraying", "springboard diving", "squat", "sticking tongue out",
    "stomping grapes", "stretching arm", "stretching leg", "strumming guitar", "surfing crowd",
    "surfing water", "sweeping floor", "swimming backstroke", "swinging baseball bat", "swinging on something",
    "table tennis", "tango dancing", "tap dancing", "tapping guitar", "tasting beer",
    "tasting food", "testifying", "texting", "throwing axe", "throwing discus", "throwing knife",
    "throwing snowballs", "trapezing", "trimming or shaving beard", "trimming trees",
    "twiddling fingers", "tying knot", "unboxing", "using computer", "using remote controller",
    "walking the dog", "washing dishes", "washing feet", "washing hair", "washing hands"
]

with open("kinetics_400_labels.txt", "w") as f:
    for label in kinetics_400_labels:
        f.write(label + "\n")

print("Tạo tệp kinetics_400_labels.txt thành công!")
